...
{
    /// <summary>
    /// 传送区域动作：继承 <see cref="StatefulAction"/>。
    /// 后台用 set_object_state 开启/关闭传送：切到 <see cref="enabledStateName"/> 状态时激活传送区域，
    ...
    public class TeleportZoneAction : StatefulAction
    {
        ...
        {
            zoneEnabled = string.IsNullOrEmpty(enabledStateName) ||
                string.Equals(state.Name, enabledStateName, System.StringComparison.OrdinalIgnoreCase);
        }
